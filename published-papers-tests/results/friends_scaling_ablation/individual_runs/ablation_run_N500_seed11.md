# KaraOS graph classifier — Friends ablation run: N500_seed11

Generated: 2026-04-30T22:02:03.418440+00:00
...
| Ablation DB | `classifier_N500_seed11.db` |
| Elapsed time | 0.0s |
...
| F1 SILENT | 0.7023 |
| Macro F1 | 0.4925 |
| Precision SPEAK | 0.8293 |
| Recall SPEAK | 0.1704 |
| Precision SILENT | 0.5515 |
| Recall SILENT | 0.9667 |
...
Full predictions saved at: `karaos_friends_graph_N500_seed11.json`
