...
async def run():
    """Main pipeline loop."""
    global _shutdown_event, _brain_orchestrator, _vision_face_scan_last  # P1.A1 SP-6.3: _vision_last_heartbeat WIRE-d (_wiring._X)
    ...
    _wiring._brain_orchestrator = BrainOrchestrator(_shutdown_event)
